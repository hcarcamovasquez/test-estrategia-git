...
using Xceed.Document.NET.Utils;
  ...
  public class Table : InsertBeforeOrAfter
  {
          ...
          case AutoFit.ColumnWidth:
            {
              ...
              if( tblPr != null )
              {
                ...
                if( type == null )
                {
                  layout.Add( new XAttribute( XName.Get( "type", Document.w.NamespaceName ), System.String.Empty ) );
        ...
        : base( document, xml )
    {
      ...
      if( style != null )
      {
        ...
        if( val != null )
        {
                    System.String cleanValue = val.Value.Replace( "-", string.Empty );
    ...
    public TextDirection TextDirection
    {
      get
      {
        ...
        if( val != null )
        {
          ...
          var success = EnumHelpers.TryParse( val.Value, out textDirectionValue );
          if( success )
